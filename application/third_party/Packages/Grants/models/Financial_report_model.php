...
class Financial_report_model extends MY_Model{
     ...
     * @return bool
     */
    function is_financial_report_initial(int $office_id):bool{
        ...
        $count_of_financial_report = $this->db->get_where('financial_report',
    ...
    function month_income_opening_balance($office_id, $start_date_of_month){
        ...
        foreach($income_accounts as $income_account){
            $opening_balances[$income_account['income_account_id']] = $this->_get_income_account_opening_balance($office_id,$income_account['income_account_id'],$start_date_of_month);
        }

        return $opening_balances;
    }

    private function _initial_opening_account_balance($office_id,$income_account_id){
        ...
        $initial_account_opening_balance_obj = $this->db->get_where('system_opening_balance',
            array('fk_office_id'=>$office_id,'fk_income_account_id'=>$income_account_id));
    ...
    private function _get_income_account_opening_balance($office_id,$income_account_id,$start_date_of_month){
        
        $is_initial_report = $this->is_financial_report_initial($office_id);

        $account_opening_balance = $this->_initial_opening_account_balance($office_id,$income_account_id);        

        if(!$is_initial_report){
            $account_opening_balance = $this->_get_to_date_account_opening_balance($office_id,$income_account_id,$start_date_of_month);
        }

        return $account_opening_balance;
    }

    private function _get_to_date_account_opening_balance($office_id,$income_account_id,$start_date_of_month){
        
        $initial_account_opening_balance = $this->_initial_opening_account_balance($office_id,$income_account_id);

        $account_last_month_income_to_date = $this->_get_account_last_month_income_to_date($office_id,$income_account_id,$start_date_of_month);

        $account_last_month_expense_to_date = $this->_get_account_last_month_expense_to_date($office_id,$income_account_id,$start_date_of_month);
    ...
    function _get_account_last_month_income_to_date($office_id,$income_account_id,$start_date_of_month){
        ...
        array('fk_office_id'=>$office_id,'voucher_date<'=>$start_date_of_month,
    ...
    function _get_account_last_month_expense_to_date($office_id,$income_account_id,$start_date_of_month){
    ...
    function month_income_account_receipts($office_id, $start_date_of_month){
        ...
        foreach($income_accounts as $income_account){
            $month_income[$income_account['income_account_id']] = $this->_get_account_month_income($office_id,$income_account['income_account_id'],$start_date_of_month);
        }

        return $month_income;
    }

    function _get_account_month_income($office_id,$income_account_id,$start_date_of_month){
        ...
        $month_income_obj = $this->db->get_where('voucher_detail',
            array('fk_office_id'=>$office_id,'voucher_type_effect_code'=>'income',
    ...
    function month_income_account_expenses($office_id, $start_date_of_month){
        ...
        foreach($income_accounts as $income_account){
            $expense_income[$income_account['income_account_id']] = $this->_get_income_account_month_expense($office_id,$income_account['income_account_id'],$start_date_of_month);
        }

        return $expense_income;
    }

    function _get_income_account_month_expense($office_id,$income_account_id,$start_date_of_month){
        $last_date_of_month = date('Y-m-t',strtotime($start_date_of_month));
    ...
    function income_accounts($office_id){
        $office_account_system_id = $this->db->get_where('office',array('office_id'=>$office_id))->row()->fk_account_system_id;
        return $this->db->select(array('income_account_id','income_account_name'))->get_where('income_account',
        array('fk_account_system_id'=>$office_account_system_id))->result_array();
    }
